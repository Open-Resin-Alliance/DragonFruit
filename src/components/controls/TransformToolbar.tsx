...
import { Hand, Move3D, Paintbrush2, LayoutGrid, ArrowDownToLine, FlipHorizontal2, Compass } from 'lucide-react';
...
export function TransformToolbar({ mode, onModeChange }: TransformToolbarProps) {
  ...
  const buttons: Array<{ mode: TransformMode; label: string; icon: React.ReactNode; hint: string }> = [
    ...
    { mode: 'autoOrient', label: 'Auto', icon: <Compass className="w-4 h-4" />, hint: 'Auto-orient for best print' },
