...
export const StickRenderer = React.memo(function StickRenderer({
  ...
  const coneA = !deferContactConesToSceneBatch && (
    <ContactConeRenderer
      ...
      contactFaceRatio={effectiveConeA.contactFaceRatio}
      contactFaceAngleRad={effectiveConeA.contactFaceAngleRad}
  ...
  const coneB = !deferContactConesToSceneBatch && (
    <ContactConeRenderer
      ...
      contactFaceRatio={effectiveConeB.contactFaceRatio}
      contactFaceAngleRad={effectiveConeB.contactFaceAngleRad}
