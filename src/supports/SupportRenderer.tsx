...
function SingleSupport({
  ...
  console.log('[SupportRenderer] Support:', support.id, 'baseFlare:', settings.baseFlare, 'parentBaseId:', support.parentBaseId, 'raft.enabled:', raft.enabled);
  ...
  return (
    ...
    >
      ...
      {!support.parentBaseId && !raft.enabled && (
