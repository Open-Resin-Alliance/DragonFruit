...
import { rasterizeLoopsScanline as rasterizeLoopsToMask, rasterizeLoopsToExistingGridScanline as rasterizeLoopsToExistingGrid } from '@/modules/island/scanline';
import { rleEncode } from '@/modules/island/rle'; // Use new RLE module
