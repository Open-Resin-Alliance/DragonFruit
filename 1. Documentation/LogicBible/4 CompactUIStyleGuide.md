...
```
*Note: `bg-neutral-750` is used across the current UI for grouped controls. If this color is ever removed from the Tailwind theme, replace it with a fixed value like `bg-[#2b2b2b]`.*
