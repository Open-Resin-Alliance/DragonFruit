...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    // Lingui-compiled catalogs: generated by `npm run i18n:compile`, and they
    // carry their own /*eslint-disable*/ header that ESLint then reports as an
    // unused directive. Editing them by hand is pointless — they get rewritten.
    "src/locales/*.js",
    ".claude/**",
    ".scratch/**",
  ]),
