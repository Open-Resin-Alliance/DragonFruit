...
function renderGeneratedTs(manifests) {
      return `/* AUTO-GENERATED FILE. DO NOT EDIT.\n * Generated by scripts/generate-builtin-simple-plugins.mjs\n */\n// @ts-nocheck\nimport type { PluginManifest } from '@/features/plugins/pluginRegistry';\n\nconst GENERATED_BUILTIN_SIMPLE_PLUGIN_MANIFESTS_RAW: readonly PluginManifest[] = ${JSON.stringify(manifests, null, 2)} as unknown as readonly PluginManifest[];\n\nexport const GENERATED_BUILTIN_SIMPLE_PLUGIN_MANIFESTS = GENERATED_BUILTIN_SIMPLE_PLUGIN_MANIFESTS_RAW as readonly PluginManifest[];\n`;
}
