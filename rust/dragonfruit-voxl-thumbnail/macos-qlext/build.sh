...
cp "$GENERATED_DIR/VoxlThumbnailExtension-Info.plist" "$CONTENTS/Info.plist"
mkdir -p "$CONTENTS/Resources"
cp "$GENERATED_DIR/../src/generated_output_file_types.json" "$CONTENTS/Resources/outputFileTypes.json"
