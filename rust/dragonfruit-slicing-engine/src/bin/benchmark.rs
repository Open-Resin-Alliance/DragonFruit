...
fn main() {
    ...
    cfg.anti_aliasing_level =
        parse_arg_string(&args, "--aa-level", &cfg.anti_aliasing_level);
    ...
    match run_benchmark_v3(cfg) {
        Ok(r) => {
            println!("[V3Bench] aa_level={} aa_mode={} blur_radius={} min_aa_alpha={:.1} artifact_bytes={} total_s={:.3} layers_per_second={:.3} render_s={:.3} png_s={:.3} archive_s={:.3}",
                cfg.anti_aliasing_level,
